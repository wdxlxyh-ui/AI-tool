...
```
edge-ems:        edgeftpfile/edge-ems/{branch}/{server}/edge-ems.tar.gz
edge-ems-hmi:    edgeftpfile/edge-ems-hmi/{branch}/{server}/edge-ems-hmi.tar.gz
edge-ems-hmi-fe: edgeftpfile/edge-ems-hmi-fe/{server_dir}/{branch}/edge-ems-hmi-fe.zip
...
```
HPUY:
  edge-ems:       /root/EMS/edge-ems/bin/
  edge-ems-hmi:   /root/EMS/edge-ems-hmi/bin/
  edge-ems-hmi-fe: /root/EMS/edge-ems-hmi-fe/ (或其他，待确认)

EE:
  edge-ems:       /home/envuser/energy-os/edge-ems/bin/
  edge-ems-hmi:   /home/envuser/energy-os/edge-ems-hmi/bin/
  edge-ems-hmi-fe: /home/envuser/energy-os/edge-ems-hmi-fe/ (或其他，待确认)
```
...
│  步骤 2: 部署到远程服务器                            │
│  ┌─────────────────────────────────────────────┐   │
│  │ 目标: admin@192.168.1.100:9991               │   │
│  │ 远程: /root/EMS/edge-ems/bin/                │   │
│  │                                [部署到服务器]  │   │
│  └─────────────────────────────────────────────┘   │
│                                                     │
│  ┌── 执行日志 ──────────────────────────────────┐   │
...
│                                         │
│ HPUY 服务器                             │
│ Host [192.168.1.100] Port [9991]       │
│ User [admin         ] PW   [••••••••]  │
│ 远程目录 [/root/EMS/                   ] │
│                                         │
│ EE 服务器                               │
│ Host [10.0.0.100  ] Port [9991]       │
│ User [root         ] PW   [••••••••]  │
